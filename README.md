...
- vertikalen Reitern ohne Seitenreload
- fortlaufendem Audio innerhalb der Charakteransicht
- Datenschutz- und Urheberrechts-Modalen

## Medien einpflegen

Lege eigene Dateien in diese Ordner:

- `assets/images/`
- `assets/audio/`

Passe danach in `js/data.js` die Dateinamen, Texte und Tabs an.
